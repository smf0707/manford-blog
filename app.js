...
const MINIAPPS = [
  ...
  {id:'p2',folder:'miniapp/p2',title:'旅游目的地地图',cat:'小程序',year:'2026',intro:'查全国热门旅游目的地：按省份 / 城市查看 Top10 最火景点，地图红色定位、热度越高越红。',detail:'一个旅游目的地查询小程序：顶部省份 / 城市下拉或输入（如"广东""广东 广州"），中部列出该地区热度最高的 10 个目的地；底部接入高德地图（深色样式），点列表项即定位放大到街道 / 建筑级，小水滴定位图标按热度染色。支持拖动平移与滚轮 / 双指缩放，悬停或点击查看简介。数据基于公开资料整理，仅供演示参考。'},
